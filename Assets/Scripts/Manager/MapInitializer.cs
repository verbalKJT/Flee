...
public class MapInitializer : MonoBehaviour
{
    ...
    [Header("Camera Holder")] private GameObject playerCameraHolder;

    [Header("VR Tutorial Canvas")] [SerializeField]
    ...
    [Header("ResetBathroom")] [SerializeField]
    private ResetBathroom resetBathroom;

    [Header("맵 속 손전등")] [SerializeField] private FlashlightPickup _flashlightPickup;

    [Header("텔레포트 위치")] [SerializeField] private Transform middleCorriderPos;
    [SerializeField] private Transform lastCorriderPos;
    [SerializeField] private Transform endRoomPos;

    [Header("작업실 맵")] [SerializeField] private GameObject map1;
    ...
    public void Initialize(GameManager manager)
    {
        ...
        playerMovement.SetTeleportPoint(middleCorriderPos,lastCorriderPos,endRoomPos);
