...
Shader "Dary_Palasky_Built-in/Body Shader Built-in_Cursed_Doll"
{
	Properties
	{
		...
		[HideInInspector][Header(_____OPACITY_____)]_Hide_Torso("Hide_Torso", Range( 0 , 1)) = 0
		[HideInInspector]_Hide_Hands("Hide_Hands", Range( 0 , 1)) = 0
		[HideInInspector]_Hide_Legs("Hide_Legs", Range( 0 , 1)) = 0
		[HideInInspector]_Hide_Groin("Hide_Groin", Range( 0 , 1)) = 0
		[HideInInspector]_Hide_Feet("Hide_Feet", Range( 0 , 1)) = 0
		[HideInInspector]_Hide_Wrists("Hide_Wrists", Range( 0 , 1)) = 0
		[HideInInspector]_Show_Fingers("Show_Fingers", Range( 0 , 1)) = 0
		...
		[NoScaleOffset]_Blood_Mask_1("Blood_Mask_1", 2D) = "white" {}
		[HideInInspector][NoScaleOffset]_Opacity("Opacity", 2D) = "white" {}
		[HideInInspector][NoScaleOffset]_Opacity_2("Opacity_2", 2D) = "white" {}
	...
	SubShader
	{
		...
		uniform sampler2D _Blood_Mask_1;
		...
		uniform float _Hide_Torso;
		uniform sampler2D _Opacity;
		uniform float _Hide_Hands;
		uniform float _Hide_Legs;
		uniform float _Hide_Groin;
		uniform sampler2D _Opacity_2;
		uniform float _Hide_Feet;
		uniform float _Hide_Wrists;
		uniform float _Show_Fingers;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 uv_Blood_Mask_141 = i.uv_texcoord;
			float4 tex2DNode41 = tex2D( _Blood_Mask_1, uv_Blood_Mask_141 );
			...
			float lerpResult222 = lerp( 0.0 , _Hide_Groin , tex2DNode242.g);
			float clampResult221 = clamp( lerpResult222 , 0.0 , 1.0 );
			float lerpResult247 = lerp( lerpResult246 , 0.0 , clampResult221);
			float lerpResult225 = lerp( 0.0 , _Hide_Feet , tex2DNode242.b);
			float clampResult224 = clamp( lerpResult225 , 0.0 , 1.0 );
			float lerpResult248 = lerp( lerpResult247 , 0.0 , clampResult224);
			float lerpResult227 = lerp( 0.0 , _Hide_Wrists , tex2DNode242.r);
			float clampResult226 = clamp( lerpResult227 , 0.0 , 1.0 );
			float lerpResult249 = lerp( lerpResult248 , 0.0 , clampResult226);
			float lerpResult229 = lerp( 0.0 , _Show_Fingers , tex2DNode242.a);
			float clampResult228 = clamp( lerpResult229 , 0.0 , 1.0 );
			float lerpResult250 = lerp( lerpResult249 , 1.0 , clampResult228);
...
Node;AmplifyShaderEditor.CommentaryNode;218;-1850.19,3262.815;Inherit;False;1572.101;1066.176;Opacity;31;244;234;243;242;219;220;232;231;230;223;239;241;240;238;237;236;235;233;229;228;227;226;225;224;222;221;245;248;249;250;287;;1,1,1,1;0;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;1001.184,2558.565;Float;False;True;-1;2;ASEMaterialInspector;0;0;Standard;Dary_Palasky_Built-in/Body Shader Built-in_Cursed_Doll;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;;0;False;;False;0;False;;0;False;;False;0;Custom;0.5;True;True;0;True;Opaque;;AlphaTest;All;12;all;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;0;0;False;;0;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;;-1;0;True;_AlphaClip;0;0;0;False;0.1;False;;0;False;;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;52;-2823.944,2389.88;Inherit;True;Property;_RMA;RMA;23;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TexturePropertyNode;37;-1860.182,605.9032;Inherit;True;Property;_Dirt_Mask;Dirt_Mask;24;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TexturePropertyNode;42;-2056.782,1392.306;Inherit;True;Property;_Blood_Mask_1;Blood_Mask_1;25;1;[NoScaleOffset];Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexturePropertyNode;260;-1837.675,-35.74736;Inherit;True;Property;_Base_Color;Base_Color;21;2;[Header];[NoScaleOffset];Create;True;1;_____TEXTURES_____;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.TexturePropertyNode;286;-1787.371,2925.262;Inherit;True;Property;_Normal;Normal;22;1;[NoScaleOffset];Create;True;1;_____TEXTURES_____;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.ClampOpNode;221;-718.4359,3757.616;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;222;-905.2608,3759.216;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;250;-451.4371,4183.28;Inherit;False;3;0;FLOAT;1;False;1;FLOAT;1;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;247;-455.9805,3760.517;Inherit;False;3;0;FLOAT;1;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;240;-1192.162,3384.071;Inherit;False;Property;_Hide_Torso;Hide_Torso;13;2;[HideInInspector];[Header];Create;True;1;_____OPACITY_____;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;241;-1190.584,3519.623;Inherit;False;Property;_Hide_Hands;Hide_Hands;14;1;[HideInInspector];Create;True;1;Head_Blood;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;239;-1185.347,3650.606;Inherit;False;Property;_Hide_Legs;Hide_Legs;15;1;[HideInInspector];Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;223;-1182.905,3778.68;Inherit;False;Property;_Hide_Groin;Hide_Groin;16;1;[HideInInspector];Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;230;-1178.181,3908.36;Inherit;False;Property;_Hide_Feet;Hide_Feet;17;1;[HideInInspector];Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;231;-1179.212,4063.458;Inherit;False;Property;_Hide_Wrists;Hide_Wrists;18;1;[HideInInspector];Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;232;-1182.374,4195.527;Inherit;False;Property;_Show_Fingers;Show_Fingers;19;1;[HideInInspector];Create;True;1;;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;243;-1785.883,3827.534;Inherit;True;Property;_Opacity_2;Opacity_2;27;2;[HideInInspector];[NoScaleOffset];Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TexturePropertyNode;219;-1785.583,3358.718;Inherit;True;Property;_Opacity;Opacity;26;2;[HideInInspector];[NoScaleOffset];Create;True;0;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;287;-1476.367,4194.321;Inherit;False;Property;_AlphaClip;AlphaClip;20;1;[HideInInspector];Create;True;0;0;0;False;0;False;0.99;0.99;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=9F5C26B7C41517624D85EB734A1BBCDCE85BEF55