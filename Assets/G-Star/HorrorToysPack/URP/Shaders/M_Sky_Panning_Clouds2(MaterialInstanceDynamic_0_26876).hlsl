...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[1] = float4(0.000176,0.000222,0.000424,1.000000);//Zenith Color
	Material.VectorExpressions[2] = float4(0.000176,0.000222,0.000424,0.000000);//(Unknown)
	Material.VectorExpressions[3] = float4(0.058559,0.057247,0.077385,1.000000);//Horizon color
	Material.VectorExpressions[4] = float4(0.058559,0.057247,0.077385,0.000000);//(Unknown)
	Material.VectorExpressions[5] = float4(0.119394,0.000000,0.992847,1.000000);//Light direction
	Material.VectorExpressions[6] = float4(0.119394,0.000000,0.992847,0.000000);//(Unknown)
	Material.VectorExpressions[7] = float4(0.119394,0.000000,0.992847,0.000000);//(Unknown)
	...
	Material.VectorExpressions[10] = float4(10.160439,2.245457,0.406418,0.000000);//(Unknown)
	Material.VectorExpressions[11] = float4(0.053950,0.059475,0.065000,1.000000);//Cloud color
	Material.VectorExpressions[12] = float4(0.053950,0.059475,0.065000,0.000000);//(Unknown)
	...
	Material.ScalarExpressions[0] = float4(0.955111,0.923810,6.695240,1.000000);//Stars brightness Sun height Horizon Falloff (Unknown)
	Material.ScalarExpressions[1] = float4(1.000000,0.000300,0.000300,3333.333252);//(Unknown) Sun Radius (Unknown) (Unknown)
	Material.ScalarExpressions[2] = float4(10.160439,1.852779,1.291408,4.000000);//Sun brightness Cloud speed Cloud opacity NoisePower2
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local2 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_0, samplerMaterial_Texture2D_0,Local0,View.MaterialTextureMipBias));
	...
	MaterialFloat4 Local27 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1, samplerMaterial_Texture2D_1,Local25,View.MaterialTextureMipBias));
	...
	MaterialFloat4 Local32 = ProcessMaterialGreyscaleTextureLookup((Texture2DSampleBias(Material_Texture2D_2, samplerMaterial_Texture2D_2,Local30,View.MaterialTextureMipBias)).r).rrrr;
	...
	MaterialFloat4 Local44 = ProcessMaterialGreyscaleTextureLookup((Texture2DSampleBias(Material_Texture2D_2, samplerMaterial_Texture2D_2,Local42,View.MaterialTextureMipBias)).r).rrrr;
